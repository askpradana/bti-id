...
const jobDesc = [
  'Monitor competition to identify new industry trends and opportunities for innovation',
  'Monitor competition to identify new industry trends and opportunities for innovation',
  'Monitor competition to identify new industry trends and opportunities for innovation',
  'Monitor competition to identify new industry trends and opportunities for innovation',
  'Monitor competition to identify new industry trends and opportunities for innovation',
...
const skillDesc = ['Java', 'Spring boot', 'Vue', 'Vite', 'Tailwind', 'Nuxt']
const titleList = [
  'Marketing Planner',
  'UI/UX Content planner',
  'HR/Legal manager',
